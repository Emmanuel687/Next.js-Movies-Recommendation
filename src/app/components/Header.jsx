      ...
      <section className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="lg:hidden flex items-center gap-3">
          ...
          <SignedOut>
            <Link href="/sign-up">
              <Button
                label="Sign in"
                icon={<LogIn className="w-4 h-4" />}
                className="px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-medium rounded-lg shadow-lg hover:shadow-indigo-500/25 transition-all duration-300 hover:scale-105 text-sm"
                text
              />
            </Link>
          </SignedOut>
          ...
          <button
            ...
            className="p-2 text-[var(--foreground)] hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-gray-100/50 dark:hover:bg-gray-800/30 rounded-lg transition-all duration-300 mobile-menu-container"
