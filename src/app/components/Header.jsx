  ...
  <section className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8">
    ...
    >
      ...
      <div className="flex flex-col group cursor-pointer">
        ...
        <span className="text-xs text-[var(--foreground)] opacity-70 font-medium">
          Discover Cinema
        </span>
      </div>
      {/* Film Name End */}
        ...
        (
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gray-50/50 dark:bg-gray-800/50 hover:bg-gray-100/50 dark:hover:bg-gray-700/50 rounded-full transition-all duration-300 border border-gray-200/50 dark:border-gray-700/50"
            >
              {/* User Avatar Start */}
              ...
              <span className="text-sm font-medium text-[var(--foreground)]">John Doe</span>
              <ChevronDown className={`w-4 h-4 text-[var(--foreground)] opacity-70 transition-transform duration-300 ${userMenuOpen ? 'rotate-180' : ''}`} />
              {/* User Name and Chevron End */}
            </button>

            {userMenuOpen && (
              <div className="absolute right-0 top-full mt-2 w-48 bg-[var(--background)]/95 backdrop-blur-lg rounded-xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 py-2 z-50">
                {/* Profile Link Start */}
                <Link href="/profile" className="block px-4 py-2 text-sm text-[var(--foreground)] hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors">
                  Profile
                </Link>
                {/* Profile Link End */}

                {/* Settings Link Start */}
                <Link href="/settings" className="block px-4 py-2 text-sm text-[var(--foreground)] hover:bg-gray-50/50 dark:hover:bg-gray-700/50 transition-colors">
                  Settings
                </Link>
                {/* Settings Link End */}
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-red-50/50 dark:hover:bg-red-950/20 transition-colors flex items-center gap-2"
                >
        ...
        (
          <div className="flex items-center gap-2">
            ...
            <Link href="/signup">
              <Button
                label="Sign up"
                className="px-4 py-2 text-sm font-medium text-[var(--foreground)] hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-gray-50/50 dark:hover:bg-gray-800/30 rounded-lg transition-all duration-300"
                text
              />
            </Link>
            {/* Sign Up Button End */}
    ...
    <button
      ...
      className="lg:hidden p-2 text-[var(--foreground)] hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-gray-100/50 dark:hover:bg-gray-800/30 rounded-lg transition-all duration-300 mobile-menu-container"
            ...
            (
              <div className="space-y-2">
                <div className="flex items-center gap-3 px-4 py-3">
                  ...
                  {/* User Name Start */}
                  <span className="font-medium text-[var(--foreground)]">John Doe</span>
                  {/* User Name End */}
                </div>
                <Link href="/profile" className="block px-4 py-2 text-[var(--foreground)] hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  Profile
                </Link>
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 text-red-600 dark:text-red-400 hover:bg-red-50/50 dark:hover:bg-red-950/20 rounded-lg transition-colors w-full text-left"
                >
                  <LogOut className="w-4 h-4" />
                  Sign out
                </button>
            ...
            (
              <div className="space-y-2">
                ...
                <Link href="/signup" onClick={() => setMenuOpen(false)}>
                  <Button
                    label="Sign up"
                    className="w-full px-4 py-3 text-[var(--foreground)] hover:bg-gray-50/50 dark:hover:bg-gray-800/30 rounded-lg transition-all duration-300 justify-center"
                    text
                  />
                </Link>
                {/* Sign Up Button End */}
