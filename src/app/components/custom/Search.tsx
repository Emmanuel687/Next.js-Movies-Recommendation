...
const Search = ({ placeholder = "Search movies...", value, onChange, className = "" }: SearchProps) => {
      ...
      >
        ...
        <SearchIcon 
          className={`w-5 h-5 transition-colors duration-300 ${
            isFocused ? "text-indigo-500 dark:text-indigo-400" : "text-gray-400 dark:text-gray-500"
          }`} 
        />
